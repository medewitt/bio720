...
## Why is "new protein synthesis" required for LTP? What are some examples of new proteins that are made?
...
## What is CPEB3, and what was already known about it before this study?
...
CPEB3 when in itys partially soluable form is thought to promote maintenance of memory formulation through the regulation of mRNA translation targets of AMPA and NMDA subunits along with actin and postsynapic density proteins. 
When CPEB3 is in its soluable form it inhibits target mRNA translation.

## What are dendritic P body-like structures? What was already known about these structures?
...
## What was the objective/hypothesis of this study?
...
![](2024-01-28-12-29-52.png)

**Q** Where does CPEB3 colocalize in the HeLa cells (and is it within the P-bodies)?

**M** Transfected HeLa cells with GFP tagged Ago2, HA-GW182. Ago2 and HA-GW182 are known to be markers of p-bodies. Using flouroscropy we can examine where these different tagged proteins locate and can assess if they are colocated (indicating that CPEB3 is likely in these target p-bodies)

**R** We see high levels of collocation of these proteins.

**C** CPEB3 appears to colocate within p-bodies.
...
**M** Coimmunoprecepitation  on transinfected HEK cells using WG182 and HA methods.

**R** Could not immunoprecipitate Algo. Found evidence of coimmunopreciptation with GW182 and the CPEB3-EGF (i). Similarly, using HA, found that coimmunopreciptation of AGO2 and CPEB3-HA (ii).

**C** These data suggest that CPEB3 and GW182 and AGO2 have direct physical interactions (and thus the different p-body proteins)
...
![](2024-01-28-13-18-07.png)


**Q** What are the critical sites required for physical interactions with the p-body associated proteins?

**M** Create truncation mutants which remove particular regions allowing us to explore their interaction (by absense of colocalization in the resulting imagery).

**R** Creation of the truncation mutants sucessful with GFP tags showing the localization

**C** These truncation mutants will work for our experimental design as we have laid it out.
...
**R** No real change in colocalization.

**C** CPEB3 does not require N-terminal domain to enter bodies.
...
**R** Very little colocation observed under imaging indicating that there is inhibition of some kind.

**C** Deletion of RRM2 does impact colocalization
...
**R** Very little disruption observed.

**C** ZnF deletion disrupts colocation with HA-Ago2
...
**C** RRM1 deletion disrupts colocation with HA-Ago2
...
Synaptic plasticity 
The ability of a neuron to modify the strength of their connections typically following the "use it or lose it" rule.
...
HEK293 cell line is immortalized human embryonic kidney cells.
